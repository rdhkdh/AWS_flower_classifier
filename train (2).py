...
parser.add_argument('--hidden_units', action="store", nargs=2, default=[500, 256], type=int, help="enter 3 integers between 1024 and 102 in decreasing order", dest="hidden_units")
...
## Check hidden units 
if 102 <= arg_hidden_units[2] <= arg_hidden_units[1] <= arg_hidden_units[0] <= 1024:
