...
parser.add_argument('--save_dir', action="store", default="flowers",
                    help="saving directory for the dataset", dest="save_directory")
...
urllib.request.urlretrieve(
    "https://s3.amazonaws.com/content.udacity-data.com/nd089/flower_data.tar.gz", "flower_data.tar.gz")
